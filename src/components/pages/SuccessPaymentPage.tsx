...
export const SuccessPaymentPage: React.FC<Props> = props => {
  ...
  return (
    <SafeAreaView style={styles.page_container}>
      ...
      <BackButton
        backScreen={Screens.ProfilePage}
        rotation={BackButtonRotation.left}
        placement={BackButtonPlacement.left}
      />

      <Body style={{marginBottom: 50}} weight={BodyWeight.Bold} size={BodySizes.Large}>
      ...
      >
        <Body color={theme.alternative.white} weight={BodyWeight.Regular} size={BodySizes.Medium}>
